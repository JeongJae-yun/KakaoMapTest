    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnRoad.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String uri ="http://maps.google.com/maps?saddr="+37.555151+","+126.869126+"&daddr="+37.556746+","+126.940327;
                Intent intent = new Intent(android.content.Intent.ACTION_VIEW,
                        Uri.parse(uri));
                intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                intent.addCategory(Intent.CATEGORY_LAUNCHER );
                intent.setClassName("app.project.com.kakaomaptest", "app.project.com.kakaomaptest.MapActivity");
